...
PyTorch Frame supports integration with existing embeddings generated by Large Language Model. With any downloaded model or embedding API endpoints, you can encode your text data with embeddings and train it with deep learning models alongside other semantic types.

We support the following (but not limited to):
<table>
  <tr>
    <td align="center">
