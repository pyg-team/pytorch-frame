...
specifying its :class:`~torch_frame.stype`: We can specify :class:`stype.text_embedded<torch_frame.stype>`
for columns we want to use option (1) and :class:`stype.text_tokenized<torch_frame.stype>` for option (2).
